...
// which has additional links.
      ...
      // Add if declination to the west, subtract if declination to the east
      // Declination of SparkFun was 8.5 degrees east, so they subtracted 8.5
      // Declination of Orono is 16 degrees west, so I add 16 degrees.
      myIMU.yaw  += 16;
...
//        Serial.print("  Roll: ");
//        Serial.println(myIMU.roll, 2); Serial.println("");

//        Serial.print("rate = ");
//        Serial.print((float)myIMU.sumCount / myIMU.sum, 2);
//        Serial.println(" Hz"); Serial.println("");
      }
